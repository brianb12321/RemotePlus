        ...
        private void mi_open_Click(object sender, EventArgs e)
        {
            ...
            switch (extension.Position)
            {
                case FormPosition.Top:
                    ClientApp.MainWindow.AddTabToMainTabControl(extension.GeneralDetails.Name, extension.ExtensionForm);
                    break;
                case FormPosition.Bottum:
                    ClientApp.MainWindow.AddTabToConsoleTabControl(extension.GeneralDetails.Name, extension.ExtensionForm);
                    break;
            }
        }
    }
